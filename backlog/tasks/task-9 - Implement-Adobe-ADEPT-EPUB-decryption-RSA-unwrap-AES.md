...
modified_files:
  - crates/dedrm-crypto/src/rsa.rs
...
Add RSA PKCS#1 v1.5 private-decrypt to dedrm-crypto (add the `rsa` crate; parse a PKCS#1 RSAPrivateKey DER) and implement dedrm-schemes::adept::decrypt_epub on top of the OCF layer (task-8).
...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 dedrm-crypto exposes RSA PKCS#1 v1.5 private-decrypt over a PKCS#1 RSAPrivateKey DER, with a unit test
